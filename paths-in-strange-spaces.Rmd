...
PsyArXiv: https://psyarxiv.com/wxn58
...
The practice of hypothesis testing in psychological science (via null hypothesis testing, Bayes factors, or what have you) is often has this character. Statistical hypothesis testing provides an elegant, clean formalism for connecting a statistical toy (your model) to a dubious measurement (your data). At the end you get a number, $p$, that is supposed to summarise what these two things have revealed to us about the world. 
...
Throughout this post I've been inserting small snippets of code^[Obviously, those code snippets are missing from the archived version!] that construct generative artwork using the "jasmines" R package^[https://github.com/djnavarro/jasmines] that I've been slowly writing. The story behind the jasmines package is an interesting one, because I started it as an exercise in reverse engineering -- I wanted to understand how Thomas Lin Pedersen was creating beautiful pieces like this one:^[Reproduced with permission. Original at https://www.data-imaginist.com/art/]

```{r echo=FALSE}
knitr::include_graphics("genesis112.png", dpi = 600)
```
...
- Scheel, A. M., Tiokhin, L., Isager, P. M., & Lakens, D. (2020, September 6). Why hypothesis testers should spend less time testing hypotheses. https://doi.org/10.31234/osf.io/vekpu
